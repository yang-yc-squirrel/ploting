...
f1.bar(t,r,width=w,color=(1,0,0),alpha=0.3)
f1.set_rlim([0,5])
f2=f.add_subplot(1,2,2)
matplotlib.pyplot.sca(f2)
jk=numpy.array([random.uniform(10,50) for _ in range(1000)]).reshape(50,20)
matplotlib.pyplot.imshow(jk,cmap=matplotlib.pyplot.get_cmap("winter"))
